...
if (command === "translist") {
    ...
    msg.channel.send(embed);
     ...
     if (command === "help"){
        ...
        if (args.length < 1){
         let embed = new Discord.RichEmbed()
                .setDescription("`Prefix:` `x` `made by:` `syrus`")
                .setAuthor("{─────────────<   永 ℍ𝔸ℝ𝕌 永   >─────────────}")
                .setColor("#000000")
                .setTimestamp()
                .addField(`>𝙃𝙀𝙇𝙋 𝘾𝙊𝙈𝙈𝘼𝙉𝘿𝙎 ───────────────────────`, '**```                - HELP NUKE \n - HELP TEXT                   - HELP SPAMMER \n \n - HELP FUN                    - HELP FUN2 \n \n - HELP INFO                   - HELP STATUS```**')
                .addField(`>𝙈𝙊𝘿 𝙊𝙉 ───────`, '**` ✅NITRO SNIPER `** \n **` ✅SLOTBOT SNIPER `** \n **` ✅MEE6 XP `**')
                .setImage('https://cdn.discordapp.com/attachments/741067790303232016/743523897617416233/11d1ad6b226a03e41ca9367d415aef44.gif');
